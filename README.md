<h1><a href="https://github.com/ArchiveBox/pydantic-pkgr"><code>pydantic-pkgr</code></a><br/><sub>Fully-typed Python 3 APIs for common system package managers.</sub></h1>
...
> 🌈 Supports [`django`](https://docs.djangoproject.com/en/5.0/) >= 4.0 and OpenAPI + [`django-jsonform`](https://django-jsonform.readthedocs.io/) out-of-the-box  
